...
void IcDriver::screenICWriteByteNoCommand(uint8_t _data) {
 ...
 */
void IcDriver::screenICWriteByte(uint8_t _data, uint8_t _cmd) {
...
GraphicsLibDriver::GraphicsLibDriver(u8g2_t *_canvasBuffer) {
  this->canvasBuffer = _canvasBuffer;
}

void GraphicsLibDriver::canvasUpdate() {
  u8g2_SendBuffer(canvasBuffer);
}

void GraphicsLibDriver::canvasClear() {
  u8g2_ClearBuffer(canvasBuffer);
}

uint8_t GraphicsLibDriver::byteCallBack(u8x8_t *u8x8, uint8_t msg, uint8_t argInt, void *argPtr) {
  switch (msg) {
...
uint8_t GraphicsLibDriver::gpioAndDelayCallBack(u8x8_t *u8x8, uint8_t msg, uint8_t argInt, void *argPtr) {
  switch (msg) {
...
void GraphicsLibDriver::graphicsLibInit() {
